...
contract UController is ControllerInterface {
     ...
     */
    function newOrganization(Avatar _avatar) external {
        ...
        organizations[address(_avatar)].schemes[msg.sender] = Scheme({
        ...
        returns (bool)
    {
        ...
        organizations[_avatar].schemes[_scheme] = Scheme({
            ...
            permissions: _permissions | bytes4(0x00000001)
        });
    ...
    function upgradeController(address _newController, Avatar _avatar)
        external
        onlyUpgradingScheme(address(_avatar))
        returns (bool)
    {
