...
async function main() {
  ...
  const omnGuild = await hre.upgrades.deployProxy(
    OMNGuild,
    [
  ...
  await proxyAdmin.changeProxyAdmin(omnGuild.address, PROXY_OWNER, {
    gasLimit: 1000000,
  });
  ...
  console.log(
    "You can get the implementation address to validate from " +
      "https://NETWORK.etherscan.io/proxyContractChecker?a=PROXY_ADDRESS"
  );
}
